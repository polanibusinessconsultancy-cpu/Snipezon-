        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Tailored Chart of Accounts>Tailored Chart of Accounts</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Audit Trail Logging>Audit Trail Logging</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Integrated Invoicing>Integrated Invoicing</h3>
      ...
      <div class="showcase-dashboard-card" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          <div class="dash-sidebar-nav">
            <div class="dash-nav-item active">Chart of Accounts</div>
            <div class="dash-nav-item">Invoice Builder</div>
            <div class="dash-nav-item">Vendor Ledgers</div>
            <div class="dash-nav-item">Receivables</div>
            <div class="dash-nav-item">Financial Reports</div>
          </div>
        ...
        <div class="dash-callouts-list">
          <span class="showcase-badge">Chart of Accounts</span>
          <span class="showcase-badge">Invoice Builder</span>
          <span class="showcase-badge">Vendor Ledgers</span>
          <span class="showcase-badge">Outstanding Balances</span>
          <span class="showcase-badge">Audit Trails</span>
        </div>
      </div>
    </section>
