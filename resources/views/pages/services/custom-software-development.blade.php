...
@section('body_data_page', 'custom-software-development')
...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Built Around You>Built Around You</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">End-to-End Delivery>End-to-End Delivery</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Reliable &amp; Future-Ready>Reliable &amp; Future-Ready</h3>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        ...
        <a href="customer-care-automation.html" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="whatsapp-business-api.html" class="related-service-card" data-animate="fade-up" data-delay="200">
          <div>
        ...
        <a href="ecommerce-websites.html" class="related-service-card" data-animate="fade-up" data-delay="300">
          <div>
