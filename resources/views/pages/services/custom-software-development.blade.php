...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="{{ route('services.ai-software') }}" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="{{ route('services.customer-care') }}" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="{{ route('services.ecommerce') }}" class="related-service-card" data-animate="fade-up" data-delay="300">
          <div>
