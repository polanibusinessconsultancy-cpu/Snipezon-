...
@section('body_data_page', 'ecommerce-websites')
...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="static-dynamic-websites.html" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="sales-bots.html" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="custom-software-development.html" class="related-service-card" data-animate="fade-up" data-delay="300">
          <div>
