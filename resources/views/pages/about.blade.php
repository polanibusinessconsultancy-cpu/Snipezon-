      ...
      <div class="about-hero-grid">
        <div class="hero-content">
          ...
          <div class="hero-ctas" data-animate="fade-up" data-delay="300">
            <a href="{{ route('digital-solutions') }}" class="button button-primary">
        ...
        <div class="dual-ecosystem-wrapper" aria-hidden="true">
          ...
          <div class="eco-core-hub">
            <img src="{{ asset('assets/images/') }}logo/logo-icon.svg" alt="Snipezon Core" width="80" height="80">
          </div>
    ...
    <section class="section container">
      ...
      <div class="divisions-grid">
        ...
        <div class="division-panel digital-panel" data-animate="fade-up">
          ...
          <a href="{{ route('digital-solutions') }}" class="button button-primary" style="align-self: flex-start;">
        ...
        <div class="division-panel" data-animate="fade-up" data-delay="100">
          ...
          <a href="{{ route('general-supply') }}" class="button button-secondary" style="align-self: flex-start;">
    ...
    <section class="section container">
      ...
      <div class="requirements-bento-grid">
        <div class="requirement-group-card" data-animate="fade-up">
          ...
          <a href="{{ route('digital-solutions') }}" class="req-card-action">Explore Solutions &rarr;</a>
        </div>
        ...
        <div class="requirement-group-card" data-animate="fade-up">
          ...
          <a href="{{ route('general-supply') }}" class="req-card-action">Explore Supply &rarr;</a>
        </div>
