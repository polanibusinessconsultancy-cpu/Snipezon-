            ...
            <div class="supply-category-grid">
              <div class="supply-mini-card">
                <div class="supply-mini-illustration">
                  <img src="{{ asset('snipezon/images/supply/home-essentials.svg') }}" alt="Home Essentials" width="80" height="80" loading="lazy">
                </div>
              ...
              <div class="supply-mini-card">
                <div class="supply-mini-illustration">
                  <img src="{{ asset('snipezon/images/supply/corporate-items.svg') }}" alt="Corporate Items" width="80" height="80" loading="lazy">
                </div>
                <div class="supply-mini-info">
              ...
              <div class="supply-mini-card">
                <div class="supply-mini-illustration">
                  <img src="{{ asset('snipezon/images/supply/industrial-items.svg') }}" alt="Industrial Items" width="80" height="80" loading="lazy">
                </div>
                <div class="supply-mini-info">
              ...
              <div class="supply-mini-card">
                <div class="supply-mini-illustration">
                  <img src="{{ asset('snipezon/images/supply/toys.svg') }}" alt="Toys" width="80" height="80" loading="lazy">
                </div>
                <div class="supply-mini-info">
      ...
      <div class="category-presentation-grid">
        ...
        <div id="home-essentials" class="category-block" data-animate="fade-up">
          <div class="category-block-image">
            <img src="{{ asset('snipezon/images/supply/home-essentials.svg') }}" alt="Home Essentials Sourcing Category" width="600" height="400" loading="lazy">
          </div>
        ...
        <div id="corporate-items" class="category-block reverse-layout" data-animate="fade-up">
          <div class="category-block-image">
            <img src="{{ asset('snipezon/images/supply/corporate-items.svg') }}" alt="Corporate Items Sourcing Category" width="600" height="400" loading="lazy">
          </div>
          <div class="category-block-content">
        ...
        <div id="industrial-items" class="category-block" data-animate="fade-up">
          <div class="category-block-image">
            <img src="{{ asset('snipezon/images/supply/industrial-items.svg') }}" alt="Industrial Items Sourcing Category" width="600" height="400" loading="lazy">
          </div>
          <div class="category-block-content">
        ...
        <div id="toys" class="category-block reverse-layout" data-animate="fade-up">
          <div class="category-block-image">
            <img src="{{ asset('snipezon/images/supply/toys.svg') }}" alt="Toys Sourcing Category" width="600" height="400" loading="lazy">
          </div>
          <div class="category-block-content">
            <h3>Toys</h3>
...
<div id="quote-confirm-modal" class="modal-backdrop" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="modal-title">
    <div class="modal-card">
      <h3 id="modal-title" class="modal-title" style="font-size:1.3rem; margin-bottom:12px; color:var(--color-text);">Confirm Supply Request Summary</h3>
