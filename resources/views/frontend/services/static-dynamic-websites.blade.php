...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
      ...
      <div class="journey-grid">
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Thoughtful Recommendation</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Modern Aesthetic Excellence</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Interactive Form Journeys</h3>
    ...
    <section class="section container">
      ...
      <div class="showcase-dashboard-card" id="static-dynamic-websites-dashboard" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          ...
          <div class="dash-sidebar-nav" role="tablist" aria-label="Corporate Web Portal Navigation">
            <button type="button" class="dash-nav-item active is-active" id="tab-sdw-hero-banner" role="tab" data-sdw-target="hero-banner" aria-selected="true" aria-controls="panel-sdw-hero-banner" tabindex="0">Hero Banner</button>
            <button type="button" class="dash-nav-item" id="tab-sdw-service-grid" role="tab" data-sdw-target="service-grid" aria-selected="false" aria-controls="panel-sdw-service-grid" tabindex="-1">Service Grid</button>
            <button type="button" class="dash-nav-item" id="tab-sdw-contact-hub" role="tab" data-sdw-target="contact-hub" aria-selected="false" aria-controls="panel-sdw-contact-hub" tabindex="-1">Contact Hub</button>
            <button type="button" class="dash-nav-item" id="tab-sdw-mobile-drawer" role="tab" data-sdw-target="mobile-drawer" aria-selected="false" aria-controls="panel-sdw-mobile-drawer" tabindex="-1">Mobile Drawer</button>
            <button type="button" class="dash-nav-item" id="tab-sdw-seo-meta" role="tab" data-sdw-target="seo-meta" aria-selected="false" aria-controls="panel-sdw-seo-meta" tabindex="-1">SEO Meta</button>
          </div>

          <!-- Main Dashboard Panels Container -->
          <div class="dash-panels-container sdw-showcase-panels">
            <!-- Panel 1: Hero Banner -->
            <div class="dash-main-area dash-panel sdw-showcase-panel is-active" id="panel-sdw-hero-banner" role="tabpanel" data-sdw-panel="hero-banner" aria-labelledby="tab-sdw-hero-banner">
            ...
            <!-- Panel 2: Service Grid -->
            <div class="dash-main-area dash-panel sdw-showcase-panel" id="panel-sdw-service-grid" role="tabpanel" data-sdw-panel="service-grid" aria-labelledby="tab-sdw-service-grid" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Bento Cards</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Modern Dark-Mode Layouts</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Micro-Animations</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Smooth Visual Triggers</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Typography</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Clear Hierarchy Focus</strong>
              </div>
            </div>

            <!-- Panel 3: Contact Hub -->
            <div class="dash-main-area dash-panel sdw-showcase-panel" id="panel-sdw-contact-hub" role="tabpanel" data-sdw-panel="contact-hub" aria-labelledby="tab-sdw-contact-hub" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Intake Forms</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Tabbed Requirement Entry</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Validation</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Client-Side Input Check</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Direct Messaging</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">One-Click WhatsApp Link</strong>
              </div>
            </div>

            <!-- Panel 4: Mobile Drawer -->
            <div class="dash-main-area dash-panel sdw-showcase-panel" id="panel-sdw-mobile-drawer" role="tabpanel" data-sdw-panel="mobile-drawer" aria-labelledby="tab-sdw-mobile-drawer" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Touch Targets</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Optimized Mobile Buttons</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Drawer Menu</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Smooth Backdrop Transition</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Viewport Testing</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">320px to 430px Tested</strong>
              </div>
            </div>

            <!-- Panel 5: SEO Meta -->
            <div class="dash-main-area dash-panel sdw-showcase-panel" id="panel-sdw-seo-meta" role="tabpanel" data-sdw-panel="seo-meta" aria-labelledby="tab-sdw-seo-meta" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Semantic Tags</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Single H1 &amp; Clean Headings</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Meta Tags</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">OpenGraph &amp; Twitter Cards</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Performance</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Lean Asset Execution</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dash-callouts-list" role="tablist" aria-label="Corporate Web Portal Bottom Navigation">
          <button type="button" class="dash-callout-item showcase-badge active is-active" id="btab-sdw-hero-banner" role="tab" data-sdw-target="hero-banner" aria-selected="true" aria-controls="panel-sdw-hero-banner" tabindex="0">Hero Banner</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sdw-service-grid" role="tab" data-sdw-target="service-grid" aria-selected="false" aria-controls="panel-sdw-service-grid" tabindex="-1">Service Grid</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sdw-contact-hub" role="tab" data-sdw-target="contact-hub" aria-selected="false" aria-controls="panel-sdw-contact-hub" tabindex="-1">Contact Hub</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sdw-mobile-drawer" role="tab" data-sdw-target="mobile-drawer" aria-selected="false" aria-controls="panel-sdw-mobile-drawer" tabindex="-1">Mobile Drawer</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sdw-seo-meta" role="tab" data-sdw-target="seo-meta" aria-selected="false" aria-controls="panel-sdw-seo-meta" tabindex="-1">SEO Meta</button>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="{{ route('services.ecommerce-websites') }}" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="{{ route('services.custom-software-development') }}" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="{{ route('services.ai-chatbot-solutions') }}" class="related-service-card" data-animate="fade-up" data-delay="200">
          <div>
