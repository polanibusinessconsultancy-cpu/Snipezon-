...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Support Staff Empowerment</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Seamless Agent Transfer</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Multi-Channel Coverage</h3>
    ...
    <section class="section container">
      ...
      <div class="showcase-dashboard-card" id="care-hub-dashboard" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          ...
          <div class="dash-sidebar-nav" role="tablist" aria-label="Customer Care Hub Sidebar Navigation">
            <button type="button" class="dash-nav-item active" id="tab-ticket-queue" role="tab" aria-selected="true" aria-controls="panel-ticket-queue" tabindex="0">Ticket Queue</button>
            <button type="button" class="dash-nav-item" id="tab-auto-routing" role="tab" aria-selected="false" aria-controls="panel-auto-routing" tabindex="-1">Automated Routing</button>
            <button type="button" class="dash-nav-item" id="tab-knowledge-matches" role="tab" aria-selected="false" aria-controls="panel-knowledge-matches" tabindex="-1">Knowledge Matches</button>
            <button type="button" class="dash-nav-item" id="tab-agent-workload" role="tab" aria-selected="false" aria-controls="panel-agent-workload" tabindex="-1">Agent Workload</button>
            <button type="button" class="dash-nav-item" id="tab-sla-analytics" role="tab" aria-selected="false" aria-controls="panel-sla-analytics" tabindex="-1">SLA Analytics</button>
          </div>

          <!-- Main Dashboard Panels -->
          <div class="dash-panels-container">
            <!-- Panel 1: Ticket Queue -->
            <div class="dash-main-area dash-panel" id="panel-ticket-queue" role="tabpanel" aria-labelledby="tab-ticket-queue">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Open Tickets</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">142 Active Tickets</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Categorization</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Automated Priority Triage</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Handover Rate</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Smooth Escalations</strong>
              </div>
            </div>

            <!-- Panel 2: Automated Routing -->
            <div class="dash-main-area dash-panel" id="panel-auto-routing" role="tabpanel" aria-labelledby="tab-auto-routing" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Inbound Channels</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Web, WhatsApp &amp; Email</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Department Queues</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Sales &amp; Tech Support</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Routing Accuracy</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">98.4% Auto-Assigned</strong>
              </div>
            </div>

            <!-- Panel 3: Knowledge Matches -->
            <div class="dash-main-area dash-panel" id="panel-knowledge-matches" role="tabpanel" aria-labelledby="tab-knowledge-matches" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Auto-Replies</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Instant FAQ Resolution</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Knowledge Base</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Verified Policy Match</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Deflection Rate</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">42% Self-Service</strong>
              </div>
            </div>

            <!-- Panel 4: Agent Workload -->
            <div class="dash-main-area dash-panel" id="panel-agent-workload" role="tabpanel" aria-labelledby="tab-agent-workload" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Active Agents</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">18 Support Reps</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Workload Status</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Balanced Capacity</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Transfer Speed</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">&lt; 15s Context Handover</strong>
              </div>
            </div>

            <!-- Panel 5: SLA Analytics -->
            <div class="dash-main-area dash-panel" id="panel-sla-analytics" role="tabpanel" aria-labelledby="tab-sla-analytics" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">First Response</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">&lt; 2 mins Average</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Resolution Time</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">14 mins Avg Handle</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">SLA Adherence</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">99.1% On-Time Resolution</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dash-callouts-list" role="tablist" aria-label="Customer Care Hub Bottom Navigation">
          <button type="button" class="dash-callout-item showcase-badge active" id="btab-ticket-queue" role="tab" aria-selected="true" aria-controls="panel-ticket-queue" tabindex="0">Ticket Queue</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-auto-routing" role="tab" aria-selected="false" aria-controls="panel-auto-routing" tabindex="-1">Automated Routing</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-knowledge-matches" role="tab" aria-selected="false" aria-controls="panel-knowledge-matches" tabindex="-1">Knowledge Matches</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-agent-workload" role="tab" aria-selected="false" aria-controls="panel-agent-workload" tabindex="-1">Agent Workload</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sla-analytics" role="tab" aria-selected="false" aria-controls="panel-sla-analytics" tabindex="-1">SLA Analytics</button>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="{{ route('services.whatsapp-business-api') }}" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="{{ route('services.ai-chatbot-solutions') }}" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="{{ route('services.custom-software-development') }}" class="related-service-card" data-animate="fade-up" data-delay="200">
          <div>
