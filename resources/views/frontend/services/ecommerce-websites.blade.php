...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Intuitive Catalog Navigation</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Frictionless Checkout</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Centralized Store Management</h3>
    ...
    <section class="section container">
      ...
      <div class="showcase-dashboard-card" id="ecommerce-websites-dashboard" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          ...
          <div class="dash-sidebar-nav" role="tablist" aria-label="Commerce Control Center Navigation">
            <button type="button" class="dash-nav-item active is-active" id="tab-ecom-product-catalog" role="tab" data-ecom-target="product-catalog" aria-selected="true" aria-controls="panel-ecom-product-catalog" tabindex="0">Product Catalog</button>
            <button type="button" class="dash-nav-item" id="tab-ecom-category-filters" role="tab" data-ecom-target="category-filters" aria-selected="false" aria-controls="panel-ecom-category-filters" tabindex="-1">Category Filters</button>
            <button type="button" class="dash-nav-item" id="tab-ecom-cart-drawer" role="tab" data-ecom-target="cart-drawer" aria-selected="false" aria-controls="panel-ecom-cart-drawer" tabindex="-1">Cart Drawer</button>
            <button type="button" class="dash-nav-item" id="tab-ecom-order-status" role="tab" data-ecom-target="order-status" aria-selected="false" aria-controls="panel-ecom-order-status" tabindex="-1">Order Status</button>
            <button type="button" class="dash-nav-item" id="tab-ecom-store-analytics" role="tab" data-ecom-target="store-analytics" aria-selected="false" aria-controls="panel-ecom-store-analytics" tabindex="-1">Store Analytics</button>
          </div>

          <!-- Main Dashboard Panels Container -->
          <div class="dash-panels-container ecom-showcase-panels">
            <!-- Panel 1: Product Catalog -->
            <div class="dash-main-area dash-panel ecom-showcase-panel is-active" id="panel-ecom-product-catalog" role="tabpanel" data-ecom-panel="product-catalog" aria-labelledby="tab-ecom-product-catalog">
            ...
            <!-- Panel 2: Category Filters -->
            <div class="dash-main-area dash-panel ecom-showcase-panel" id="panel-ecom-category-filters" role="tabpanel" data-ecom-panel="category-filters" aria-labelledby="tab-ecom-category-filters" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Attribute Taxonomy</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Multi-Level Categories</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Search Index</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Fast Keyword Search</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Filter Controls</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Instant Attribute Sliders</strong>
              </div>
            </div>

            <!-- Panel 3: Cart Drawer -->
            <div class="dash-main-area dash-panel ecom-showcase-panel" id="panel-ecom-cart-drawer" role="tabpanel" data-ecom-panel="cart-drawer" aria-labelledby="tab-ecom-cart-drawer" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Shopping Cart</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Slide-Out Cart Drawer</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Checkout Flow</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Guest &amp; User Checkout</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Cost Calculations</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Real-Time Tax &amp; Shipping</strong>
              </div>
            </div>

            <!-- Panel 4: Order Status -->
            <div class="dash-main-area dash-panel ecom-showcase-panel" id="panel-ecom-order-status" role="tabpanel" data-ecom-panel="order-status" aria-labelledby="tab-ecom-order-status" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Fulfillment Status</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Live Tracking Updates</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Order Receipts</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Automated PDF Receipts</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Customer Alerts</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">WhatsApp Order Confirmations</strong>
              </div>
            </div>

            <!-- Panel 5: Store Analytics -->
            <div class="dash-main-area dash-panel ecom-showcase-panel" id="panel-ecom-store-analytics" role="tabpanel" data-ecom-panel="store-analytics" aria-labelledby="tab-ecom-store-analytics" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Revenue Metrics</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Daily Sales Summaries</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Top Products</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Best Selling Analytics</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Conversion Trends</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Traffic Insight Logging</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dash-callouts-list" role="tablist" aria-label="Commerce Control Center Bottom Navigation">
          <button type="button" class="dash-callout-item showcase-badge active is-active" id="btab-ecom-product-catalog" role="tab" data-ecom-target="product-catalog" aria-selected="true" aria-controls="panel-ecom-product-catalog" tabindex="0">Product Catalog</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-ecom-category-filters" role="tab" data-ecom-target="category-filters" aria-selected="false" aria-controls="panel-ecom-category-filters" tabindex="-1">Category Filters</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-ecom-cart-drawer" role="tab" data-ecom-target="cart-drawer" aria-selected="false" aria-controls="panel-ecom-cart-drawer" tabindex="-1">Cart Drawer</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-ecom-order-status" role="tab" data-ecom-target="order-status" aria-selected="false" aria-controls="panel-ecom-order-status" tabindex="-1">Order Status</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-ecom-store-analytics" role="tab" data-ecom-target="store-analytics" aria-selected="false" aria-controls="panel-ecom-store-analytics" tabindex="-1">Store Analytics</button>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="{{ route('services.static-dynamic-websites') }}" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="{{ route('services.whatsapp-business-api') }}" class="related-service-card" data-animate="fade-up" data-delay="200">
          <div>
        ...
        <a href="{{ route('services.custom-software-development') }}" class="related-service-card" data-animate="fade-up" data-delay="300">
          <div>
