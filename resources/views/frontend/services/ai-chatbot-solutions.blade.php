...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Verified Knowledge Sources</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Controlled Response Rules</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Multi-Agent Handovers</h3>
    ...
    <section class="section container">
      ...
      <div class="showcase-dashboard-card" id="ai-chatbot-showcase" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          ...
          <div class="dash-sidebar-nav" role="tablist" aria-label="AI Chatbot Control Center Navigation">
            <button type="button" class="dash-nav-item active is-active" id="tab-aic-knowledge-sources" role="tab" data-chatbot-target="knowledge-sources" aria-selected="true" aria-controls="panel-aic-knowledge-sources" tabindex="0">Knowledge Sources</button>
            <button type="button" class="dash-nav-item" id="tab-aic-chat-widget" role="tab" data-chatbot-target="chat-widget" aria-selected="false" aria-controls="panel-aic-chat-widget" tabindex="-1">Chat Widget</button>
            <button type="button" class="dash-nav-item" id="tab-aic-citations" role="tab" data-chatbot-target="citations" aria-selected="false" aria-controls="panel-aic-citations" tabindex="-1">Citations</button>
            <button type="button" class="dash-nav-item" id="tab-aic-human-takeover" role="tab" data-chatbot-target="human-takeover" aria-selected="false" aria-controls="panel-aic-human-takeover" tabindex="-1">Human Takeover</button>
            <button type="button" class="dash-nav-item" id="tab-aic-analytics" role="tab" data-chatbot-target="analytics" aria-selected="false" aria-controls="panel-aic-analytics" tabindex="-1">Analytics</button>
          </div>

          <!-- Main Dashboard Panels Container -->
          <div class="dash-panels-container chatbot-showcase-panels">
            <!-- Panel 1: Knowledge Sources -->
            <div class="dash-main-area dash-panel chatbot-showcase-panel is-active" id="panel-aic-knowledge-sources" role="tabpanel" data-chatbot-panel="knowledge-sources" aria-labelledby="tab-aic-knowledge-sources">
            ...
            <!-- Panel 2: Chat Widget -->
            <div class="dash-main-area dash-panel chatbot-showcase-panel" id="panel-aic-chat-widget" role="tabpanel" data-chatbot-panel="chat-widget" aria-labelledby="tab-aic-chat-widget" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">UI Theme</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Brand-Styled Interface</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Navigation Aids</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Multi-Language Quick Replies</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Deployment Mode</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Embedded Web Launcher</strong>
              </div>
            </div>

            <!-- Panel 3: Citations -->
            <div class="dash-main-area dash-panel chatbot-showcase-panel" id="panel-aic-citations" role="tabpanel" data-chatbot-panel="citations" aria-labelledby="tab-aic-citations" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Grounding Layer</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Source Document Quotes</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">RAG Vector Search</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">High Confidence Passage Matching</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Verification</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Verifiable Data Passages</strong>
              </div>
            </div>

            <!-- Panel 4: Human Takeover -->
            <div class="dash-main-area dash-panel chatbot-showcase-panel" id="panel-aic-human-takeover" role="tabpanel" data-chatbot-panel="human-takeover" aria-labelledby="tab-aic-human-takeover" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Escalation Trigger</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Live Agent Escalation</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Context Transfer</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Transcript History Passed</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Staff Alert</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Instant Staff Notification</strong>
              </div>
            </div>

            <!-- Panel 5: Analytics -->
            <div class="dash-main-area dash-panel chatbot-showcase-panel" id="panel-aic-analytics" role="tabpanel" data-chatbot-panel="analytics" aria-labelledby="tab-aic-analytics" hidden style="display: none;">
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Topic Insights</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Top Asked Questions</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">User Rating</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Satisfaction Ratings Tracked</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Deflection Efficiency</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Measurable Support Deflection</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dash-callouts-list" role="tablist" aria-label="AI Chatbot Control Center Bottom Navigation">
          <button type="button" class="dash-callout-item showcase-badge active is-active" id="btab-aic-knowledge-sources" role="tab" data-chatbot-target="knowledge-sources" aria-selected="true" aria-controls="panel-aic-knowledge-sources" tabindex="0">Knowledge Sources</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-aic-chat-widget" role="tab" data-chatbot-target="chat-widget" aria-selected="false" aria-controls="panel-aic-chat-widget" tabindex="-1">Chat Widget</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-aic-citations" role="tab" data-chatbot-target="citations" aria-selected="false" aria-controls="panel-aic-citations" tabindex="-1">Citations</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-aic-human-takeover" role="tab" data-chatbot-target="human-takeover" aria-selected="false" aria-controls="panel-aic-human-takeover" tabindex="-1">Human Takeover</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-aic-analytics" role="tab" data-chatbot-target="analytics" aria-selected="false" aria-controls="panel-aic-analytics" tabindex="-1">Analytics</button>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        ...
        <a href="{{ route('services.whatsapp-business-api') }}" class="related-service-card" data-animate="fade-up" data-delay="100">
          <div>
        ...
        <a href="{{ route('services.customer-care-automation') }}" class="related-service-card" data-animate="fade-up" data-delay="200">
          <div>
