...
<!-- 1. BREADCRUMB AND SERVICE HERO -->
        ...
        <div class="journey-map-card" data-animate="fade-up" data-delay="100">
          <div class="sidebar-checklist" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">24/7 Inquiry Coverage</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Pre-Qualified Sales Leads</h3>
            ...
            <div style="background: rgba(255,255,255,0.03); padding: 16px; border-radius: var(--radius-small); border: 1px solid var(--color-border-light);">
              <h3 style="color: var(--color-cyan); font-size: 1rem; margin-bottom: 6px;">Multi-Channel Deployment</h3>
    ...
    <section class="section container">
      ...
      <div class="showcase-dashboard-card" id="sales-bots-dashboard" data-animate="fade-up">
        ...
        <div class="dash-grid-layout">
          ...
          <div class="dash-sidebar-nav" role="tablist" aria-label="Sales Qualification Assistant Navigation">
            <button type="button" class="dash-nav-item active" id="tab-sb-product-matcher" role="tab" aria-selected="true" aria-controls="panel-sb-product-matcher" tabindex="0">Product Matcher</button>
            <button type="button" class="dash-nav-item" id="tab-sb-lead-intake" role="tab" aria-selected="false" aria-controls="panel-sb-lead-intake" tabindex="-1">Lead Intake</button>
            <button type="button" class="dash-nav-item" id="tab-sb-req-summary" role="tab" aria-selected="false" aria-controls="panel-sb-req-summary" tabindex="-1">Requirement Summary</button>
            <button type="button" class="dash-nav-item" id="tab-sb-sales-alert" role="tab" aria-selected="false" aria-controls="panel-sb-sales-alert" tabindex="-1">Sales Alert</button>
            <button type="button" class="dash-nav-item" id="tab-sb-crm-sync" role="tab" aria-selected="false" aria-controls="panel-sb-crm-sync" tabindex="-1">CRM Sync</button>
          </div>

          <!-- Main Dashboard Panels -->
          <div class="dash-panels-container">
            <!-- Panel 1: Product Matcher -->
            <div class="dash-main-area dash-panel" id="panel-sb-product-matcher" role="tabpanel" aria-labelledby="tab-sb-product-matcher">
            ...
            <!-- Panel 2: Lead Intake -->
            <div class="dash-main-area dash-panel" id="panel-sb-lead-intake" role="tabpanel" aria-labelledby="tab-sb-lead-intake" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Intake Form</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Structured Visitor Specs</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Requirement Capture</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Budget &amp; Timeline Filtered</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Contact Verification</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Verified Email &amp; Phone</strong>
              </div>
            </div>

            <!-- Panel 3: Requirement Summary -->
            <div class="dash-main-area dash-panel" id="panel-sb-req-summary" role="tabpanel" aria-labelledby="tab-sb-req-summary" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Summary Card</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Custom Quote Specs</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Product Line</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Multi-Category Selection</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Priority Rating</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Immediate Sales Review</strong>
              </div>
            </div>

            <!-- Panel 4: Sales Alert -->
            <div class="dash-main-area dash-panel" id="panel-sb-sales-alert" role="tabpanel" aria-labelledby="tab-sb-sales-alert" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Dispatch Method</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Email &amp; WhatsApp Alert</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Assigned Rep</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Senior Account Manager</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Response Target</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">&lt; 10 Mins Warm Contact</strong>
              </div>
            </div>

            <!-- Panel 5: CRM Sync -->
            <div class="dash-main-area dash-panel" id="panel-sb-crm-sync" role="tabpanel" aria-labelledby="tab-sb-crm-sync" hidden>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Destination</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">Central Sales CRM</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Data Transfer</span>
                <strong style="font-size: 1.1rem; color: var(--color-cyan);">Full Conversation Context</strong>
              </div>
              <div class="dash-widget">
                <span style="font-size: 0.75rem; color: var(--color-text-secondary); display: block;">Sync Status</span>
                <strong style="font-size: 1.1rem; color: var(--color-text);">100% Real-Time Record</strong>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="dash-callouts-list" role="tablist" aria-label="Sales Qualification Assistant Bottom Navigation">
          <button type="button" class="dash-callout-item showcase-badge active" id="btab-sb-product-matcher" role="tab" aria-selected="true" aria-controls="panel-sb-product-matcher" tabindex="0">Product Matcher</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sb-lead-intake" role="tab" aria-selected="false" aria-controls="panel-sb-lead-intake" tabindex="-1">Lead Intake</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sb-req-summary" role="tab" aria-selected="false" aria-controls="panel-sb-req-summary" tabindex="-1">Requirement Summary</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sb-sales-alert" role="tab" aria-selected="false" aria-controls="panel-sb-sales-alert" tabindex="-1">Sales Alert</button>
          <button type="button" class="dash-callout-item showcase-badge" id="btab-sb-crm-sync" role="tab" aria-selected="false" aria-controls="panel-sb-crm-sync" tabindex="-1">CRM Sync</button>
        </div>
      </div>
    </section>
    ...
    <section class="section container">
      ...
      <div class="related-services-grid">
        <a href="{{ route('services.ai-chatbot-solutions') }}" class="related-service-card" data-animate="fade-up">
          <div>
        ...
        <a href="{{ route('services.customer-care-automation') }}" class="related-service-card" data-animate="fade-up" data-delay="300">
          <div>
