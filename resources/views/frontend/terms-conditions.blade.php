...
@section('meta_description', 'Terms and Conditions of Use for the Snipezon website - General website terms, service inquiries, and liability disclaimers.')
@section('body_data_page', 'terms-conditions')

@section('page_css')
  <link rel="stylesheet" href="{{ asset('snipezon/css/pages/legal.css') }}">
@endsection
