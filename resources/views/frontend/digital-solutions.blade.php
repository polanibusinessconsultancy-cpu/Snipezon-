    ...
    <section class="solutions-hero-section container">
      ...
      <div class="solutions-hero-grid">
        ...
        <div class="command-centre-wrapper" aria-hidden="true">
          ...
          <div class="cc-core">
            <img src="{{ asset('snipezon/images/logo/logo-icon.svg') }}" alt="Snipezon Mark" width="90" height="90">
          </div>
      ...
      <div class="work-cards-grid">
        ...
        <a href="portfolio.html" class="work-card" data-animate="fade-up">
          <div class="work-card-preview">
            <img src="{{ asset('snipezon/images/portfolio/business-automation.svg') }}" alt="Business Operations Platform Representative Solution" width="600" height="360" loading="lazy">
          </div>
        ...
        <a href="portfolio.html" class="work-card" data-animate="fade-up" data-delay="100">
          <div class="work-card-preview">
            <img src="{{ asset('snipezon/images/portfolio/ai-support-workspace.svg') }}" alt="AI Customer Support Workspace Representative Solution" width="600" height="360" loading="lazy">
          </div>
          <div class="work-card-body">
            <div class="work-tags">
              <span class="work-tag">Representative Solution</span>
        ...
        <a href="portfolio.html" class="work-card" data-animate="fade-up" data-delay="200">
          <div class="work-card-preview">
            <img src="{{ asset('snipezon/images/portfolio/ecommerce-platform.svg') }}" alt="Modern E-commerce Experience Representative Solution" width="600" height="360" loading="lazy">
          </div>
          <div class="work-card-body">
            <div class="work-tags">
              <span class="work-tag">Representative Solution</span>
